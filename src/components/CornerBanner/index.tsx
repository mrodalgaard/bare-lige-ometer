...
const StyledVersion = styled.p`
  position: absolute;
  height: ${({ theme }) => theme.sizes.banner};
  width: ${({ theme }) => theme.sizes.banner};
  display: flex;
...
export const CornerBanner = () => {
  ...
  return (
    <StyledLink href={GITHUB_LINK} aria-label="Github" onClick={onClick}>
      <svg xmlns="http://www.w3.org/2000/svg" width={banner} height={banner} viewBox="0 0 250 250" fill={background}>
